...
"""autogenerated by genpy from qt_ros_demo01/Arm.msg. Do not edit."""
import codecs
import sys
...
"""
  __slots__ = ['joint']
  _slot_types = ['qt_ros_demo01/Joint[]']
