...
(cl:in-package qt_ros_demo01-msg)
...
(cl:defclass <Arm> (roslisp-msg-protocol:ros-message)
  ((joint
    :reader joint
    :initarg :joint
    :type (cl:vector qt_ros_demo01-msg:Joint)
   :initform (cl:make-array 0 :element-type 'qt_ros_demo01-msg:Joint :initial-element (cl:make-instance 'qt_ros_demo01-msg:Joint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Arm>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Arm)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qt_ros_demo01-msg:<Arm> is deprecated: use qt_ros_demo01-msg:Arm instead.")))

(cl:ensure-generic-function 'joint-val :lambda-list '(m))
(cl:defmethod joint-val ((m <Arm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ros_demo01-msg:joint-val is deprecated.  Use qt_ros_demo01-msg:joint instead.")
  (joint m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Arm>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'joint)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'qt_ros_demo01-msg:Joint))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Arm>)))
  ...
  (cl:format cl:nil "Joint[] joint~%================================================================================~%MSG: qt_ros_demo01/Joint~%int32 id~%int32 run_time~%float32 angle~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Arm)))
  "Returns full string definition for message of type 'Arm"
  (cl:format cl:nil "Joint[] joint~%================================================================================~%MSG: qt_ros_demo01/Joint~%int32 id~%int32 run_time~%float32 angle~%~%~%"))
