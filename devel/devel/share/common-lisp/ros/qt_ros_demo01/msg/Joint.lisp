...
(cl:defmethod cl:initialize-instance :after ((m <Joint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Joint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name qt_ros_demo01-msg:<Joint> is deprecated: use qt_ros_demo01-msg:Joint instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Joint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ros_demo01-msg:id-val is deprecated.  Use qt_ros_demo01-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'run_time-val :lambda-list '(m))
(cl:defmethod run_time-val ((m <Joint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ros_demo01-msg:run_time-val is deprecated.  Use qt_ros_demo01-msg:run_time instead.")
  (run_time m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <Joint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader qt_ros_demo01-msg:angle-val is deprecated.  Use qt_ros_demo01-msg:angle instead.")
  (angle m))
